 ...
 * Use the {@link ManageCategory#newInstance} factory method to
...
public class ManageCategory extends Fragment {
    ...
    public static ManageCategory newInstance(String param1, String param2) {
        ManageCategory fragment = new ManageCategory();
